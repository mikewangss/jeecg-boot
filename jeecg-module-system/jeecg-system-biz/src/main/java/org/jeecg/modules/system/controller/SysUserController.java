...
//    @Autowired
//    private IApplySupplierService iApplySupplierService;
    @Autowired
...
//            }
//        }
//        LambdaQueryWrapper<ApplySupplier> query = new LambdaQueryWrapper<>();
//        query.eq(ApplySupplier::getSupplierName, jsonObject.getString("supplierName"));
//        ApplySupplier applySupplier1 = iApplySupplierService.getOne(query);
//        if (applySupplier1 != null) {
//            result.setMessage("供应商已注册");
//            result.setSuccess(false);
//            return result;
//        }
//        if(null == code){
...
//		}
        ...
        try {
            ...
            sysUserService.addUserWithRole(user, "1736929082010660866");//默认临时角色 供应商
...
//            Date start_date = sdf.parse(jsonObject.getJSONArray("businessLicenseDate").get(0).toString());
//            Date end_date = sdf.parse(jsonObject.getJSONArray("businessLicenseDate").get(1).toString());
//            applySupplier.setBusinessLicenseStartDate(start_date);
//            applySupplier.setBusinessLicenseEndDate(end_date);
...
//            iApplySupplierService.save(applySupplier);

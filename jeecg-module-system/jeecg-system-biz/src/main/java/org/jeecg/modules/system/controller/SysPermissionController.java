...
//            //2.根据permission_id更新sys_role_permission
...
//            List<SysRolePermission> permRuleList = sysRolePermissionService.getSysRolePermissionListByPermId(sysPermissionDataRule.getPermissionId());
//            for (SysRolePermission sysRolePermission : permRuleList
//            ) {
//                Set<String> permissionSet = new HashSet<>();
//                String listPermissionId = sysRolePermission.getPermissionId();
//                if (listPermissionId != null) {
//                    String[] permissions = listPermissionId.split(",");
//                    permissionSet.addAll(Arrays.asList(permissions));
//                }
//                // 将新的权限添加到 Set 中
//                permissionSet.add(sysPermissionDataRule.getPermissionId());
//                // 使用逗号重新构建字符串
//                String uniqueListPermissionId = String.join(",", permissionSet);
//                sysRolePermission.setDataRuleIds(uniqueListPermissionId);

...
public class FlowDefinitionServiceImpl extends FlowServiceFactory implements IFlowDefinitionService {
    ...
    public Result startProcessInstanceById(String procDefId, Map<String, Object> variables) {
        ...
        String username = variables.get(ProcessConstants.PROCESS_INITIATOR).toString();
        ...
        if (!doneUserList.contains(username)) {
            doneUserList.add(username);
        }

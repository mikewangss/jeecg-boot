 ...
 */
@Data
@ApiModel(value="apply_infoPage对象", description="结算申请")
public class ApplyInfoPage {
	...
	@ExcelCollection(name="结算申请流程")
	@ApiModelProperty(value = "结算申请流程")
	private List<ApplyWorkflowDTO> applyWorkflowDTOList;
